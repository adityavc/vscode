...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
	...
	command: {
		...
		title: nls.localize('makeSecret', "Make Secret")
	},
	when: ContextKeyExpr.and(ExplorerFolderContext.toNegated(), ExplorerResourceAvailableEditorIdsContext),
});
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
